package gcs.project.Server;

import java.sql.SQLException;
import java.util.HashMap;

import gcs.project.Common.NetworkAccess;
import gcs.project.Common.User;
...
public class CommandProtocol {
	...
	private static String MySQLpassword = ""; // empty for public view
	...
	public static void processCommand(String cmd, NetworkAccess na, ClientHandler ch) throws SQLException {
		...
		if (cmd.equals("disconnect")) { ///////////////////////////////////////////////////////////////////////////////
			...
			dbc = new DBaseConnection("root", MySQLpassword);
